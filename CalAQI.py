...
def CalO3Aqi_1(o3aver_1):
    if 0 <= o3aver_1 <= 0.059:
        ...
        o3aqi = (((o3aver_1 - 54) * (100 - 51)) / (0.075 - 0.060)) + 51
        return o3aqi
    elif 0.076 <= o3aver_1 <= 0.095:
        o3aqi = (((o3aver_1 - 101) * (150 - 101)) / (0.095 - 0.076)) + 101
        return o3aqi
    elif 0.096 <= o3aver_1 <= 0.115:
        o3aqi = (((o3aver_1 - 361) * (200 - 151)) / (0.115 - 0.096)) + 151
        return o3aqi
    elif 0.116 <= o3aver_1 <= 0.374:
        o3aqi = (((o3aver_1 - 650) * (300 - 201)) / (0.374 - 0.116)) + 201
        return o3aqi
    else:
        return 501
...
def CalO3Aqi_8(o3aver_8):
    if 0.125 <= o3aver_8 <= 0.164:
        o3aqi = (((o3aver_8-125) * (150-101)) / (0.164-0.125)) + 101
        return o3aqi
    elif 0.165 <= o3aver_8 <= 0.204:
        o3aqi = (((o3aver_8-165) * (200-151)) / (0.204-0.165)) + 151
        return o3aqi
    elif 0.205 <= o3aver_8 <= 0.404:
        o3aqi = (((o3aver_8-205) * (300-201)) / (404-205)) + 201
        return o3aqi
    elif 0.405 <= o3aver_8 <= 0.604:
        o3aqi = (((o3aver_8-405) * (300-201)) / (504-405)) + 301
        return o3aqi
    else:
        return 501
...
def CalPm25Aqi(pm25aver):
    if 0 <= pm25aver <= 15.4:
        ...
        pm25aqi = (((pm25aver - 12.1) * (100 - 51)) / (40.4 - 15.5)) + 51
        return pm25aqi
    elif 40.4 <= pm25aver <= 65.4:
        pm25aqi = (((pm25aver - 35.5) * (150 - 101)) / (65.4 - 40.4)) + 101
        return pm25aqi
    elif 65.5 <= pm25aver <= 150.4:
        pm25aqi = (((pm25aver - 55.5) * (200 - 151)) / (150.4 - 65.5)) + 151
        return pm25aqi
